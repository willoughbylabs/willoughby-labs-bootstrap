        ...
        <div class="page-body text-center">
            ...
            <section class="d-flex flex-wrap justify-content-center">
                ...
                <div class="card mb-3 mx-2">
                    <div class="card-body">
                        <h5 class="card-title">
                            <a href="https://github.com/willoughbylabs/cscrub-api" target="_blank"
                                rel="noopener noreferrer">CScrub
                                API
                                <i class="bi bi-github"></i>
                            </a>
                        </h5>
                        ...
                        <p class="card-text">A JSON API that shares council members, legislation, and votes from Chicago City
                            Council
                            meetings.</p>
                ...
                <div class="card mb-3 mx-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">A tribute to the Black, Medal of Honor veteran from Chicago who sacrificed his life
                            for
                            others.</p>
